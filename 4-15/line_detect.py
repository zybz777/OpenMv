...
class LineDetect:
    ...
    def line_track(self, img, grayLine=[(62, 100, -128, 127, -128, 127)], roi=(0, 20, 80, 40), err=5):
        """ 线性回归处理中线 """
        direct = 0
        angle_deg = 0
    ...
    def line_track_grass(self, img, grayLine=[(60, 100, -128, 127, -128, 127)], roi=(0, 20, 80, 40), err=5):
        """ 线性回归处理中线 """
        direct = 0
        angle_deg = 0
